...
export default function LoginPage() {
    ...
    return (
        <main className="min-h-screen bg-[#030712] flex overflow-hidden">
            {/* Left Side: Professional 3D AI Robot Image */}
            <div className="hidden lg:flex lg:w-1/2 relative overflow-hidden bg-black">
                ...
                <div className="relative z-20 p-16 flex flex-col justify-between h-full w-full">
                    ...
                    <div className="max-w-md">
                        ...
                        >
                            Your AI SDR is <br /> <span className="text-blue-500">ready to work.</span>
                        </motion.h2>
                        <p className="text-gray-400 text-lg leading-relaxed">
                            Sign in to manage your campaigns, monitor dashboard activity, and scale your pipeline.
                        </p>
                    </div>

                    <div className="grid grid-cols-2 gap-4">
                        <div className="p-4 bg-white/5 backdrop-blur-md rounded-2xl border border-white/10">
                            <span className="block text-white font-bold text-xl mb-1">2,400+</span>
                            <span className="text-gray-500 text-xs uppercase font-bold tracking-widest">Leads Contacted</span>
                        </div>
                        <div className="p-4 bg-white/5 backdrop-blur-md rounded-2xl border border-white/10">
                            <span className="block text-white font-bold text-xl mb-1">85%</span>
                            <span className="text-gray-500 text-xs uppercase font-bold tracking-widest">Meeting Rate</span>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div className="w-full lg:w-1/2 flex items-center justify-center p-8 md:p-16 relative bg-[#030712]">
                ...
                >
                    <div className="mb-8 text-center lg:text-left">
                        ...
                        <p className="text-white/80 text-sm">Access your AI SDR dashboard and settings.</p>
                    </div>
                    ...
                    <form className="space-y-5" onSubmit={handleLogin}>
                        ...
                        <div className="relative flex items-center justify-center py-1">
                            ...
                            <span className="mx-4 text-white/50 text-[10px] font-black uppercase tracking-[0.2em]">Quick Access</span>
                            <div className="flex-grow border-t border-white/20"></div>
                        </div>
                    ...
                    <div className="mt-8 text-center pt-6 border-t border-white/20">
                        <p className="text-white/60 font-medium text-xs">
                            First time here?{' '}
                            <Link href="/signup" className="text-blue-400 font-bold hover:text-blue-300 transition-colors uppercase tracking-widest ml-1">
                                Create Account
                            </Link>
                        </p>
                    </div>
