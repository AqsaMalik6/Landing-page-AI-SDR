      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center">
          ...
          <div className="hidden md:flex items-center gap-6">
            <button className="flex items-center gap-2 text-gray-400 font-semibold hover:text-white transition-colors group">
              <LogIn className="w-4 h-4 group-hover:-translate-x-1 transition-transform" />
              Sign In
            </button>
            <button className="px-6 py-3 bg-white text-black rounded-full font-bold hover:bg-blue-50 transition-all duration-300 hover:scale-105 active:scale-95 shadow-lg">
              Get Started
            </button>
          </div>
          ...
          >
            <div className="px-6 py-8 space-y-6">
              ...
              <div className="pt-6 space-y-4 border-t border-white/10">
                <button className="w-full flex items-center justify-center gap-2 py-4 text-white font-bold border border-white/10 rounded-2xl hover:bg-white/5 transition-colors">
                  <LogIn className="w-5 h-5" />
                  Sign In
                </button>
                <button className="w-full py-4 bg-white text-black rounded-2xl font-black text-lg hover:bg-blue-50 transition-colors">
                  Get Started
                </button>
              </div>
            </div>
